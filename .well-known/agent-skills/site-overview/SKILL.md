...
**Abdelrahman Saed** (also known as **binSaed**) is a **Lead Mobile Engineer (Flutter)** with 7+ years shipping production Flutter apps for iOS and Android to 5M+ users. The site is a personal portfolio whose primary purpose is hiring: it advertises who he is, what he ships, and that **he is currently available for hire** — open to Lead and Staff Mobile Engineer roles on a **full-time, fractional leadership, contract, or technical advisory** basis, remote worldwide or hybrid / on-site across the Gulf & Egypt.
