import{c as r,j as e}from"./index-Dq5vuyZd.js";import{u as c}from"./useInView-C4ERPsbB.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const y=r("Smartphone",[["rect",{width:"14",height:"20",x:"5",y:"2",rx:"2",ry:"2",key:"1yt0o3"}],["path",{d:"M12 18h.01",key:"mhygvu"}]]),x=[{category:"Mobile Development",icon:y,items:["Flutter","Dart","Android","iOS","React Native"]},{category:"Frontend",icon:m,items:["React","TypeScript","JavaScript","HTML/CSS","Tailwind CSS"]},{category:"Backend",icon:d,items:["Node.js","Python","Firebase","REST APIs","GraphQL"]},{category:"Cloud & DevOps",icon:l,items:["AWS","Google Cloud","Docker","CI/CD","Git"]},{category:"Programming",icon:n,items:["Clean Code","Design Patterns","SOLID Principles","TDD","Agile"]},{category:"Design",icon:p,items:["UI/UX","Figma","Material Design","Responsive Design","Animation"]}];function u(){const{ref:o,isInView:a}=c({margin:"-100px"});return e.jsx("section",{id:"skills",className:"py-24",ref:o,children:e.jsxs("div",{className:"container mx-auto px-6",children:[e.jsxs("div",{className:`text-center mb-16 opacity-0 ${a?"animate-fade-in-up":""}`,children:[e.jsxs("h2",{className:"text-3xl md:text-4xl font-bold mb-4",children:["My ",e.jsx("span",{className:"gradient-text",children:"Skills"})]}),e.jsx("p",{className:"text-muted-foreground max-w-2xl mx-auto",children:"Technologies and tools I work with to bring ideas to life"})]}),e.jsx("div",{className:"grid md:grid-cols-2 lg:grid-cols-3 gap-6",children:x.map((t,s)=>e.jsxs("div",{className:`bg-card rounded-xl p-6 card-shadow animated-border group opacity-0 ${a?"animate-fade-in-up":""}`,style:{animationDelay:`${s*.1}s`},children:[e.jsxs("div",{className:"flex items-center gap-4 mb-4",children:[e.jsx("div",{className:"p-3 rounded-lg bg-primary/10 text-primary group-hover:bg-primary group-hover:text-primary-foreground transition-colors duration-300",children:e.jsx(t.icon,{className:"h-6 w-6"})}),e.jsx("h3",{className:"font-semibold text-lg",children:t.category})]}),e.jsx("div",{className:"flex flex-wrap gap-2",children:t.items.map(i=>e.jsx("span",{className:"px-3 py-1 text-sm rounded-full bg-muted text-muted-foreground hover:bg-primary/10 hover:text-primary transition-colors cursor-default",children:i},i))})]},t.category))})]})})}export{u as SkillsSection};
