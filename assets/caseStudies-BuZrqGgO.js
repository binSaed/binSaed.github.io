import{D as r,l as t}from"./index-CtxI2ZNw.js";const o="https://bnsaed.com",l="https://avatars.githubusercontent.com/u/33700292?v=4&s=512",h=[{key:"problem",label:"The Problem"},{key:"solution",label:"The Solution"},{key:"architecture",label:"Architecture"},{key:"performance",label:"Performance"},{key:"results",label:"Results"}],d=[{slug:"istoria",title:"iStoria",subtitle:"Scaling story-based English learning to 5M+ learners",description:"How I helped take iStoria from founding to 5M+ learners — an offline-first Flutter architecture across a 50+ module codebase, growth features from streaks and a social leaderboard to the iStro AI companion, and a release cycle cut from four weeks to one across 800+ merged PRs.",date:"2026-06-29",readTime:"8 min read",tags:["Flutter","EdTech","Offline-first","Architecture","Scale"],heroImage:"/project-images/istoria.webp",role:"Founding → Lead Mobile Engineer",timeline:"2022 — Present",platforms:["iOS","Android"],links:[{label:"Visit iStoria",url:"https://istoria.app/en/"}],metrics:[{value:"5M+",label:"Learners reached"},{value:"99.9%",label:"Crash-free sessions"},{value:"50+",label:"Feature modules"},{value:"800+",label:"PRs merged"},{value:"75%",label:"Shorter release cycle"},{value:"30K+",label:"Abuse accounts blocked"}],problem:`iStoria teaches English through short, narrated stories. To make that work for **5M+ learners across iOS and Android**, the mobile app had to clear several hard constraints at once:
...
A small library with an outsized footprint: a focused tool that solved a recurring problem well enough that thousands of other apps now rely on it. The companion guide below walks through using it end-to-end.`}];function u(e){return d.find(a=>a.slug===e)}function i(){return{"@type":"Person","@id":`${o}/#person`,name:r.name,url:`${o}/`,image:l,jobTitle:r.role,sameAs:[t.github,t.linkedin,t.stackoverflow,t.pubdev]}}function n(e){return`${e}T00:00:00+00:00`}function p(e,a,s){return{"@context":"https://schema.org","@type":["TechArticle","Article"],headline:`${e.title} — Case Study`,name:e.title,description:e.description,image:s,inLanguage:"en",datePublished:n(e.date),dateModified:n(e.dateModified||e.date),author:i(),publisher:i(),keywords:e.tags.join(", "),about:{"@type":"SoftwareApplication",name:e.title,applicationCategory:"EducationalApplication",operatingSystem:(e.platforms||[]).join(", ")},mainEntityOfPage:{"@type":"WebPage","@id":a},url:a}}export{h as C,p as a,d as c,u as g};
