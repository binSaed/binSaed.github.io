...
A small library with an outsized footprint: a focused tool that solved a recurring problem well enough that thousands of other apps now rely on it. The companion guide below walks through using it end-to-end.`,lessons:"Three things this package reinforced:\n\n- **Compose, don't reinvent.** Wrapping `flutter_pdfview` and `flutter_cache_manager` beat writing a Dart PDF engine — smaller, faster, and it inherited native rendering quality for free.\n- **Make the right thing the default.** Adoption came from *removing* decisions: cached, offline-capable, native rendering with no configuration. Good defaults are a feature.\n- **Maintenance is the product.** Six years of staying current with Flutter is the reason apps still depend on it. Publishing a package is a commitment, not a drop."}];function p(e){return l.find(r=>r.slug===e)}function d(){return{"@type":"Person","@id":`${a}/#person`,name:n.name,url:`${a}/`,image:s,jobTitle:n.role,sameAs:[t.github,t.linkedin,t.youtube,t.stackoverflow,t.pubdev]}}const c={"@type":"Organization","@id":`${a}/#brand`,name:n.name,url:`${a}/`,logo:{"@type":"ImageObject",url:`${a}/icon-512.png`,width:512,height:512},sameAs:[t.github,t.linkedin,t.youtube,t.stackoverflow,t.pubdev]};function o(e){return`${e}T00:00:00+00:00`}function f(e,r,i){return{"@context":"https://schema.org","@type":["TechArticle","Article"],headline:`${e.title} — Case Study`,name:e.title,description:e.description,image:i,inLanguage:"en",datePublished:o(e.date),dateModified:o(e.dateModified||e.date),author:d(),publisher:c,keywords:e.tags.join(", "),about:{"@type":"SoftwareApplication",name:e.title,applicationCategory:"EducationalApplication",operatingSystem:(e.platforms||[]).join(", ")},mainEntityOfPage:{"@type":"WebPage","@id":r},url:r}}export{u as C,f as a,l as c,p as g};
