const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AboutSection-B9Tj4D1l.js","assets/radix-C0ZQseSV.js","assets/react-vendor-GBp8saLZ.js","assets/SectionHeader-B-DDZocf.js","assets/ExperienceSection-FThE-prh.js","assets/ProjectsSection-UlGzxsVP.js","assets/arrow-up-right-DNEUdaBl.js","assets/ArticlesSection-oA-k1rkY.js","assets/SkillsSection-BJVjHZjY.js","assets/RecommendationsSection-Jl9uKXYR.js","assets/FAQSection-C34LG2wV.js","assets/ContactSection-Dv1w8CbG.js","assets/mail-D3KY_c3k.js","assets/Footer-Dc_om7LD.js","assets/ArticlePage-D7SGwSRw.js","assets/arrow-left-B4vbVxAO.js","assets/ArticlesPage-bRmBk8R4.js","assets/RecommendationsPage-DVMzHrKf.js","assets/ProjectsPage-BwaywO0F.js"])))=>i.map(i=>d[i]);
var zr=Object.defineProperty;var xa=e=>{throw TypeError(e)};var Jr=(e,t,n)=>t in e?zr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var Ce=(e,t,n)=>Jr(e,typeof t!="symbol"?t+"":t,n),vn=(e,t,n)=>t.has(e)||xa("Cannot "+n);var d=(e,t,n)=>(vn(e,t,"read from private field"),n?n.call(e):t.get(e)),_=(e,t,n)=>t.has(e)?xa("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,n),k=(e,t,n,a)=>(vn(e,t,"write to private field"),a?a.call(e,n):t.set(e,n),n),O=(e,t,n)=>(vn(e,t,"access private method"),n);var en=(e,t,n,a)=>({set _(s){k(e,t,s,n)},get _(){return d(e,t,a)}});import{j as o,V as ms,R as fs,A as gs,C as bs,T as ys,D as ws,P as Wr,a as vs,b as Kr,S as Vr,O as hn,c as pn,d as ta,e as mn,f as fn,g as xs,h as ks,i as Qr,k as Ts,l as Yr,m as Xr,n as Ss,o as Zr}from"./radix-C0ZQseSV.js";import{a as eo,r as f,R as w,v as to,g as na,u as aa,c as Es,L as ka,B as no,d as ao,e as bt,N as so}from"./react-vendor-GBp8saLZ.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();const ro="modulepreload",oo=function(e){return"/"+e},Ta={},le=function(t,n,a){let s=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),i=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));s=Promise.allSettled(n.map(h=>{if(h=oo(h),h in Ta)return;Ta[h]=!0;const u=h.endsWith(".css"),p=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${h}"]${p}`))return;const g=document.createElement("link");if(g.rel=u?"stylesheet":ro,u||(g.as="script"),g.crossOrigin="",g.href=h,i&&g.setAttribute("nonce",i),document.head.appendChild(g),u)return new Promise((y,c)=>{g.addEventListener("load",y),g.addEventListener("error",()=>c(new Error(`Unable to preload CSS for ${h}`)))})}))}function r(l){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=l,window.dispatchEvent(i),!i.defaultPrevented)throw l}return s.then(l=>{for(const i of l||[])i.status==="rejected"&&r(i.reason);return t().catch(r)})};var _s,Sa=eo;_s=Sa.createRoot,Sa.hydrateRoot;const io=1,lo=1e6;let xn=0;function co(){return xn=(xn+1)%Number.MAX_SAFE_INTEGER,xn.toString()}const kn=new Map,Ea=e=>{if(kn.has(e))return;const t=setTimeout(()=>{kn.delete(e),Gt({type:"REMOVE_TOAST",toastId:e})},lo);kn.set(e,t)},uo=(e,t)=>{switch(t.type){case"ADD_TOAST":return{...e,toasts:[t.toast,...e.toasts].slice(0,io)};case"UPDATE_TOAST":return{...e,toasts:e.toasts.map(n=>n.id===t.toast.id?{...n,...t.toast}:n)};case"DISMISS_TOAST":{const{toastId:n}=t;return n?Ea(n):e.toasts.forEach(a=>{Ea(a.id)}),{...e,toasts:e.toasts.map(a=>a.id===n||n===void 0?{...a,open:!1}:a)}}case"REMOVE_TOAST":return t.toastId===void 0?{...e,toasts:[]}:{...e,toasts:e.toasts.filter(n=>n.id!==t.toastId)}}},on=[];let ln={toasts:[]};function Gt(e){ln=uo(ln,e),on.forEach(t=>{t(ln)})}function ho({...e}){const t=co(),n=s=>Gt({type:"UPDATE_TOAST",toast:{...s,id:t}}),a=()=>Gt({type:"DISMISS_TOAST",toastId:t});return Gt({type:"ADD_TOAST",toast:{...e,id:t,open:!0,onOpenChange:s=>{s||a()}}}),{id:t,dismiss:a,update:n}}function po(){const[e,t]=f.useState(ln);return f.useEffect(()=>(on.push(t),()=>{const n=on.indexOf(t);n>-1&&on.splice(n,1)}),[e]),{...e,toast:ho,dismiss:n=>Gt({type:"DISMISS_TOAST",toastId:n})}}function Rs(e){var t,n,a="";if(typeof e=="string"||typeof e=="number")a+=e;else if(typeof e=="object")if(Array.isArray(e)){var s=e.length;for(t=0;t<s;t++)e[t]&&(n=Rs(e[t]))&&(a&&(a+=" "),a+=n)}else for(n in e)e[n]&&(a&&(a+=" "),a+=n);return a}function As(){for(var e,t,n=0,a="",s=arguments.length;n<s;n++)(e=arguments[n])&&(t=Rs(e))&&(a&&(a+=" "),a+=t);return a}const _a=e=>typeof e=="boolean"?`${e}`:e===0?"0":e,Ra=As,sa=(e,t)=>n=>{var a;if((t==null?void 0:t.variants)==null)return Ra(e,n==null?void 0:n.class,n==null?void 0:n.className);const{variants:s,defaultVariants:r}=t,l=Object.keys(s).map(u=>{const p=n==null?void 0:n[u],g=r==null?void 0:r[u];if(p===null)return null;const y=_a(p)||_a(g);return s[u][y]}),i=n&&Object.entries(n).reduce((u,p)=>{let[g,y]=p;return y===void 0||(u[g]=y),u},{}),h=t==null||(a=t.compoundVariants)===null||a===void 0?void 0:a.reduce((u,p)=>{let{class:g,className:y,...c}=p;return Object.entries(c).every(v=>{let[m,b]=v;return Array.isArray(b)?b.includes({...r,...i}[m]):{...r,...i}[m]===b})?[...u,g,y]:u},[]);return Ra(e,l,h,n==null?void 0:n.class,n==null?void 0:n.className)};/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const go=f.forwardRef(({color:e="currentColor",size:t=24,strokeWidth:n=2,absoluteStrokeWidth:a,className:s="",children:r,iconNode:l,...i},h)=>f.createElement("svg",{ref:h,...fo,width:t,height:t,stroke:e,strokeWidth:a?Number(n)*24/Number(t):n,className:Ps("lucide",s),...i},[...l.map(([u,p])=>f.createElement(u,p)),...Array.isArray(r)?r:[r]]));/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const me=(e,t)=>{const n=f.forwardRef(({className:a,...s},r)=>f.createElement(go,{ref:r,iconNode:t,className:Ps(`lucide-${mo(e)}`,a),...s}));return n.displayName=`${e}`,n};/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
